...
var PartnerSpecificValidator = require('real-vu-nob-validator.js');
...
function RealVuNob(configs) {
    ...
    (function __constructor() {
        ...
        __profile = {
            partnerId: 'RealVuNob', // PartnerName
            namespace: 'RealVuNob', // Should be same as partnerName
            statsId: 'RVU', // Unique partner identifier
            version: '2.0.0',
            targetingType: 'slot',
            enabledAnalytics: {
                requestTime: true
